            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group required">
                  ...
                  <div class="col-sm-8">
                      <input type="text" name="itemname" maxlength="50" value="{{$nplitems->item_name}}" placeholder="Item Name" id="" class="form-control" >
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                      ...
                      <input type="text" name="description" maxlength="50" value="{{$nplitems->description}}" placeholder="Description" id="" class="form-control" >
            ...
            <div class="row">
              ...
              <div class="col-md-4 ">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="supplier" maxlength="50" value="{{$nplitems->supplier}}" placeholder="supplier" id="" class="form-control" >
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    ...
                    <input type="text" name="cost" maxlength="50" value="{{$nplitems->cost}}" placeholder="Cost" id="" class="form-control" onkeypress="return isNumberKey(event)" >
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    ...
                    <input type="text" name="sellingprice" maxlength="50" value="{{$nplitems->selling_price}}" placeholder="Selling Price" id="" class="form-control" onkeypress="return isNumberKey(event)" >
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    ...
                    <input type="text" name="qtyonhand" maxlength="50" value="{{$nplitems->qty_on_hand}}" placeholder="Qty On Hand" id="" class="form-control" onkeypress="return isNumberKey(event)" >
                    <div class="text-danger"></div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    ...
                    <input type="text" name="sellingunit" maxlength="50" value="{{$nplitems->selling_unit}}" placeholder="Selling Unit" id="" class="form-control" onkeypress="return isNumberKey(event)" >
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="col-sm-8" style="margin-top:5px;">
                    ...
                    @if($nplitems->WIC_item == 'Y')
                   
                    <input type="radio" name="wicitem"  id="" class="form-control" value="Y" checked>
                    <label>Yes</label>
                    <input type="radio" name="wicitem"  id="" class="form-control" value="N">
                    <label>No</label>
                    @elseif($nplitems->WIC_item == 'N')
