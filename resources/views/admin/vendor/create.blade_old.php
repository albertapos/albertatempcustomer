...
<section class="content">
    <div class="container box box-body"><br>
        <ul class="nav nav-tabs">
            <li class="active"><a data-toggle="pill" href="#basic_detail">Store Details</a></li>
        ...
        {!! Form::open(['url'=>'admin/vendors', 'method'=>'Post', 'files'=> true,'id'=>'form1']) !!}
                        ...
                        <div class="row  col-xs-offset-1">
                            <div class="row"><br>
                                <div class="form-group col-xs-5">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control required" name="name" value="{{ old('name') }}" id="name" required>
                                    </div>
                                </div>
                                <div class="form-group col-xs-5">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-xs-5">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control" maxlength="5" name="zip" value="{{ old('zip') }}" id="zip">
                                    </div>
                                </div>
                             ...
                             <div class="row">
                                <div class="form-group col-xs-5">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control" maxlength="10" name="phone" value="{{ old('phone') }}" id="phone">
                                    </div>
                                </div>
                                <div class="form-group col-xs-5">
                             ...
                             <div class="row">
                                ...
                                <div class="form-group col-xs-5">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control" name="db_username" value="{{ old('db_username') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xs-5">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control" name="db_password" value="{{ old('db_password') }}">
                                    </div>
                                </div>
                                <div class="form-group col-xs-5">
                                    <label class="control-label">Database Host</label>
                                    <div class="">
                                        <input type="text" class="form-control" name="db_hostname" value="{{ old('db_hostname') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-xs-10">
                                    ...
                                    <div class="">
                                        <textarea class="textarea" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" name="description" value=" old('description') "></textarea>
                                   </div>
                                </div>
                            </div>
                    </div>
            ...
            <div id="user" class="tab-pane"><br>
                <div class="panel panel-default col-xs-offset-1" style="width:900px">
                    ...
                    <div class="row col-xs-offset-1">
                        <div class="form-group col-xs-5">
                            <div class="">
                               {!! Form::select('userName[]', $user_array,null,['class'=>'form-control','multiple']) !!}<br>   
                            </div>
                        </div>
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    $('.multistore').on('click', function (e) {
        e.preventDefault();
