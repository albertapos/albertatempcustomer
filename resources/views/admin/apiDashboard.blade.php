...
<div class="wrapper row-offcanvas row-offcanvas-left">
    <section class="content">
        <div class="row">
            ...
            <input type="hidden" name='sid' id= "sid" value="{{ SESSION::get('selected_store_id') }}" >
                <!-- small box -->
        ...
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-body padding15">
                           <strong><h2 class="md-title" align="center"><sup style="font-size: 20px;line-height: 25px;">Sales Summary ( {{ date('D M j Y',strtotime($date)) }} )</sup></strong></h2>
                             <div class="box-body chart-responsive">
       ...
       <!--  <div class="">
        ...
        <div class="row">
              <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-body padding15">
                        <strong><h2 class="md-title" align="center"><sup style="font-size: 20px;line-height: 25px;">Past 24 Hours Customer Flow</sup></strong></h2>
...
<script src="{{ asset('assets/js/dashboardApi.js') }}"></script>
