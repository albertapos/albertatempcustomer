    ...
    <section class="content">
        ...
        <div class="row">
                <div class="col-md-6">
                    <div class="panel panel-default">
                        <div class="panel-body padding15">
                            <strong><h2 class="md-title " align="center"><sup style="font-size: 20px">Last 7 Day Sales Chart</sup></strong></h2>
                ...
                <div class="col-md-6">
                    <div class="panel panel-default">
                        <div class="panel-body padding15">
                            <strong><h2 class="md-title" align="center"><sup style="font-size: 20px">Last 7 Day Customer Chart</sup></strong></h2>
                            <div class="box-body chart-responsive">
        ...
        <div class="row">
            <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-body padding15">
                           <strong><h2 class="md-title" align="center"><sup style="font-size: 20px">Sales Summary</sup></strong></h2>
                             <div class="box-body chart-responsive">
       ...
       <!--  <div class="">
        ...
        <div class="row">
              <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-body padding15">
                        <strong><h2 class="md-title" align="center"><sup style="font-size: 20px">24 Hour Customer Data</sup></strong></h2>
                         <div class="box-body chart-responsive">
