  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <form action="<?php echo $edit;?>" method="post" enctype="multipart/form-data" id="form-settings">
          <div class="row">
            <div class="col-md-5">
              ...
              <div class="table-responsive" >
                ...
                <div class="div-table-content" style="">
                  <table class="table table-bordered table-hover" id="itemsort2">
                    <tbody>
                      <?php if(isset($pre_items_listings) && count($pre_items_listings)){ ?>
...
<script type="text/javascript">
  ...
  $(document).on('submit', 'form#form-settings', function(event) {
    ...
    if($("#itemsort2").find('tr').length > 10){
