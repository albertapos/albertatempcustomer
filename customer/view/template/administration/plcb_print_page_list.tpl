      ...
      <div class="" style="margin-top:2%;">
        <div class="row" style="width:100%;margin-bottom:-15px;">
          <div class="col-md-4" style="width:25%;display:inline-block;">
            <span style="font-size:10px;margin-top:0px;"><b>Store Name: <?php echo $store_data['vstorename'];?></b><br><b>Store Address: </b><?php echo $store_data['vaddress1'];?><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $store_data['vcity'];?>, <?php echo $store_data['vstate'];?> <?php echo $store_data['vzip'];?><br><b>Store Phone: </b><?php echo $storephone;?></span>
          </div>
