            ...
            <div class="col-md-12">
               ...
               <div class="col-md-6">
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tr>
                            <th>Total Sales</th>
                            <td class="text-right"><?php echo isset($report_sub_totals[0]['Totalsales']) ? $report_sub_totals[0]['Totalsales']: 0; ?></td>
                        </tr>
                        ...
                        <tr>
                            <th>EBT Cash</th>
                            <td class="text-right"><?php echo isset($report_sub_totals[0]['EBT_Cash_Payments']) ? $report_sub_totals[0]['EBT_Cash_Payments']: 0; ?></td>
                        ...
                        <tr>
                            ...
                            <td class="text-right"><?php echo $credit_card_total = isset($report_sub_totals[0]['Credit_Card_Payments']) ? $report_sub_totals[0]['Credit_Card_Payments']: 0; ?></td>
                        ...
                        <tr>
                            ...
                            <td class="text-right"><?php echo $drawer_total = ($cash + $lotto_sales + $other_liability_sales + $house_charge_payments + $bottle_deposit - $payouts - $house_charged - $bottle_deposit_redeem - $credit_card_total - $check - $coupon); ?></td>
                        ...
                        <tr>
                            ...
                            <td class="text-right"><?php echo $collected_cash = isset($report_total_shift_cash[0]['TotalAmount']) ? $report_total_shift_cash[0]['TotalAmount']: 0; ?></td>
                        ...
                        <tr>
                            ...
                            <td class="text-right"><?php echo $collected_cash - $drawer_total; ?></td>
                        ...
                        <tr>
                            <th>Void Total</th>
                            <td class="text-right"><?php echo isset($report_void_sale_amount[0]['Void_Amount']) ? $report_void_sale_amount[0]['Void_Amount']: 0; ?></td>
                        </tr>
                        
                        <tr>
                            <th>Delete Total</th>
                            <td class="text-right"><?php echo isset($report_deleted_sales[0]['Deleted_Items_Amount']) ? $report_deleted_sales[0]['Deleted_Items_Amount']: 0; ?></td>
                        </tr>                
                ...
                <div class="col-md-6">
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <td class="text-right"><?php //echo isset($report_sub_totals[0]['totalsales_withtax']) ? $report_sub_totals[0]['totalsales_withtax']: 0; ?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-right"><?php echo isset($report_sales_total[0]['No_of_Sales']) ? $report_sales_total[0]['No_of_Sales']: 0; ?></td>                    
                        ...
                        <tr>
                            <th>Gross Cost</th>
                            <td class="text-right"><?php echo isset($report_liability_sales[0]['Gross_Cost']) ? $report_liability_sales[0]['Gross_Cost']: 0; ?></td>
                        </tr>
