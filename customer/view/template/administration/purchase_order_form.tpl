        ...
        <div class="row" style="padding-bottom: 15px;float: right;">
          <div class="col-md-12">
            <div class="">
              ...
              <a href="<?php echo $cancel; ?>" data-toggle="tooltip" title="<?php echo $button_cancel; ?>" class="btn btn-default cancel_btn_rotate" id="cancel_button"><i class="fa fa-reply"></i>&nbsp;&nbsp;Cancel</a>
            </div>
          </div>
        </div>
          ...
          <div class="tab-content responsive">
                        ...
                        <div class="col-sm-8">
                          ...
                          <?php if(isset($vendors) && count($vendors) > 0){?>
                            <?php foreach($vendors as $vendor){?>
                              <?php if($vendor['isupplierid'] == $vvendorid){?>
            ...
            <div class="tab-pane" id="item_tab">
              <div class="row" <?php if(isset($estatus) && $estatus == 'Close'){ ?> style="pointer-events:none;" <?php } ?>>
                ...
                <div>
                    <span style="padding-left: 15px;">* Max 500 items</span>
                </div>
                <div class="col-md-6">
              ...
              <div class="row" <?php if(isset($estatus) && $estatus == 'Close'){ ?> style="pointer-events:none;" <?php } ?>>
                <div class="col-md-12">
                  <table class="table table-bordered table-hover">
                    <thead>
                      <tr>
                        <th rowspan="2" style="width: 1px;vertical-align: middle;" class="text-center"><input type="checkbox" onclick="$('input[name*=\'selected_purchase_item\']').prop('checked', this.checked);" /></th>
                        ...
                        <th rowspan="2" style="vertical-align: middle;" class="text-right">Unit Price</th>
                        <th rowspan="2" style="vertical-align: middle;" class="text-right">Last Cost Price</th>
                        <th rowspan="2" style="vertical-align: middle;" class="text-right">QOH</th>
                        <th class="text-center" colspan="6">Order Information</th>
                      </tr>
                      <tr>
                        <th class="text-right">Order Case</th>
                        ...
                        ?>
                          <tr id="tab_tr_<?php echo $item['vitemid']; ?>">
                            ...
                            <td class="text-right">
                              ...
                              <input type="text" class="nnewunitprice_class" name="items[<?php echo $k; ?>][dunitprice]" id="" style="width:60px;text-align: right;" value="<?php echo $item['dunitprice']; ?>">
                            </td>
                            
                            <td class="text-right">
                              <input type="text" disabled class="nlastcasstprice_class" name="items[<?php echo $k; ?>][last_costprice]" value="<?php echo $item['last_costprice']; ?>" id="" style="width:50px;text-align: right;background: rgb(220, 220, 220);">
                            </td>
                            ...
                            <td class="text-right">
                              <input type="text" class="nunitcost_class" name="items[<?php echo $k; ?>][nunitcost]" value="<?php echo $item['nunitcost']; ?>" id="" style="width:80px;text-align: right;">
                            </td>
                            <td class="text-right">
...
<script type="text/javascript">
  ...
  $(document).on('keypress', 'input[name="ntaxtotal"], input[name="nfreightcharge"], input[name="ndeposittotal"], input[name="nreturntotal"], input[name="ndiscountamt"], input[name="nripsamt"], .nordextprice_class, .nunitcost_class,.nnewunitprice_class, .nripamount_class', function(event) {
    if ((event.which != 46 || $(this).val().indexOf('.') != -1) && (event.which < 48 || event.which > 57)) {
      event.preventDefault();
    }
  }); 
        ...
        if(datas){
          ...
          $.each(datas, function(index, item) {
            ...
            if(item.vvendoritemcode != null){
              html_purchase_item += '<td style="width:20%;"><input type="text" class="vvendoritemcode_class" name="items['+window.index_item+'][vvendoritemcode]" value="'+item.vvendoritemcode+'" id="" style="width:100px;"></td>';
            }else{
              html_purchase_item += '<td style="width:20%;"><input type="text" class="vvendoritemcode_class" name="items['+window.index_item+'][vvendoritemcode]" value="" id="" style="width:100px;"></td>';
            }

            if(item.vsize != null){
              html_purchase_item += '<td style="width:10%;">'+item.vsize+'<input type="hidden" class="vsize_class" name="items['+window.index_item+'][vsize]" value="'+item.vsize+'" id="" ></td>';
            }else{
              html_purchase_item += '<td style="width:10%;">'+item.vsize+'<input type="hidden" class="vsize_class" name="items['+window.index_item+'][vsize]" value="" id="" ></td>';
            }

            html_purchase_item += '<td class="text-right"><input type="text" class="nnewunitprice_class" name="items['+window.index_item+'][dunitprice]" id="" style="width:60px;text-align:right;" value="'+ item.dunitprice +'"></td>';
            ...
            html_purchase_item += '<td class="text-right"><input type="text" class="nordqty_class" name="items['+window.index_item+'][nordqty]" id="" style="width:60px;text-align:right;" value="0"></td>';
            ...
            html_purchase_item += '<td class="text-right"><span class="itotalunit_span_class">0</span><input type="hidden" class="itotalunit_class" name="items['+window.index_item+'][itotalunit]" value="0" id="" style="width:80px;text-align:right;"></td>';
            html_purchase_item += '<td class="text-right"><input type="text" class="nordextprice_class" name="items['+window.index_item+'][nordextprice]" value="0.00" id="" style="width:80px;text-align:right;"></td>';
            html_purchase_item += '<td class="text-right"><input type="text" class="nunitcost_class" name="items['+window.index_item+'][nunitcost]" value="0.0000" id="" style="width:80px;text-align:right;"></td>';
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-md-3">
            <button class="btn btn-success" id="add_selected_items">Add to PO</button>&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
          </div>
        </div><br>
        <div class="row">
          <div class="col-md-12">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var total_items = "<?php echo count($items); ?>";
        if(total_items >= 500)
        {
        ...
        success: function(data) {
          ...
          if(data.items.length > 0){
            ...
            $.each(data.items, function(i, value) {
              ...
              search_table_html += '<tr>';
              search_table_html += '<td><input type="checkbox" name="selected_search_history_items[]" value="'+ value.iitemid +'"><input type="hidden" name="item_vendor" class="item_vendor" value="'+ value.ivendorid +'"></td>';
              search_table_html += '<td>';
              search_table_html += value.vbarcode;
              search_table_html += '</td>';
              search_table_html += '<td>';
  ...
  $(document).on('click', '#add_selected_items', function(event) {
    event.preventDefault();
      ...
      if($('#search_vendor_item_code').val() != '' && $('#search_item_history').val() == ''){
        ...
        var add_purchase_order_item_url = '<?php echo $get_vendor_item_code_data; ?>';
        var sid = '<?php echo $sid; ?>';
      ...
      success: function(result) {
        ...
        if(result.items){
          $.each(result.items, function(index, item) {
            ...
            html_purchase_item += '<td class="text-right"><input type="text" class="nnewunitprice_class" name="items['+window.index_item+'][dunitprice]" id="" style="width:60px;text-align:right;" value="'+ item.dunitprice +'"></td>';
            html_purchase_item += '<td class="text-right"><input type="text" disabled class="nlastunitprice_class" name="items['+window.index_item+'][last_costprice]" id="" style="width:60px;text-align:right;background: rgb(220, 220, 220);" value="'+ item.last_costprice +'"></td>';
            html_purchase_item += '<td class="text-right">'+ item.iqtyonhand +'<input type="hidden" name="items['+window.index_item+'][nitemqoh]" value="'+ item.iqtyonhand +'"></td>';
            html_purchase_item += '<td class="text-right"><input type="text" class="nordqty_class" name="items['+window.index_item+'][nordqty]" id="" style="width:60px;text-align:right;" value="0"></td>';
            html_purchase_item += '<td class="text-right"><input type="text" class="npackqty_class" name="items['+window.index_item+'][npackqty]" value="'+item.npack+'" id="" style="width:60px;text-align:right;"></td>';
            html_purchase_item += '<td class="text-right"><span class="itotalunit_span_class">0</span><input type="hidden" class="itotalunit_class" name="items['+window.index_item+'][itotalunit]" value="0" id="" style="width:80px;text-align:right;"></td>';
...
<script type="text/javascript">
  $(document).on('click', '.item_history_btn', function(event) {
    ...
    if($('input[name="custom_start_date"]').val() != '' && $('input[name="custom_end_date"]').val() != ''){
      ...
      var get_item_history_url = '<?php echo $get_item_history_date; ?>';
