                ...
                <div class="col-md-3">
                  <select name="month" class="form-control" id="month">
                    ...
                    <?php for($month=1; $month <=12; $month++){ ?>
                      <?php if(isset($selected_month) && ($selected_month == $month)){ ?>
                        <option value="<?php $dateObj   = DateTime::createFromFormat('!m', $month); echo $monthName = $dateObj->format('F'); ?>" selected="selected"><?php $dateObj   = DateTime::createFromFormat('!m', $month); echo $monthName = $dateObj->format('F'); ?></option>
                      <?php } else { ?>
                        <option value="<?php $dateObj   = DateTime::createFromFormat('!m', $month); echo $monthName = $dateObj->format('F'); ?>"><?php $dateObj   = DateTime::createFromFormat('!m', $month); echo $monthName = $dateObj->format('F'); ?></option>
                      <?php } ?>
                    <?php } ?>
                  </select>
                </div>
        ...
        <div class="alert alert-info" style="overflow: hidden;">
          <div class="row">
             ...
             <div class="col-md-6 pull-right" style="">
                 <span><b>Store Name: </b><?php echo $storename; ?></span>
             </div>
          </div>
          ...
          <div class="row">
              ...
              <div class="col-md-6 pull-right" style="">
                 <span><b>Store Address: </b><?php echo $storeaddress; ?></span>
             </div>
          </div>
          ...
          <div class="row">
             ...
             <div class="col-md-6 pull-right" style="">
                 <span><b>Store Phone: </b> <?php echo $storephone; ?></span>
             </div>
          </div>
    ...
    req.onreadystatechange = function () {
      if (req.readyState === 4 && req.status === 200) {
        ...
        if (typeof window.navigator.msSaveBlob === 'function') {
          window.navigator.msSaveBlob(req.response, "PLCB-Report.pdf");
        } else {
          var blob = req.response;
          var link = document.createElement('a');
          link.href = window.URL.createObjectURL(blob);
          link.download = "PLCB-Report.pdf";
