            ...
            <?php if ($vendors) { ?>
              <thead>
                <tr>
                  ...
                  <th class="text-left"><?php echo $column_supplier_code; ?></th>
              ...
              <tbody>
                ...
                <tr id="vendor-row<?php echo $vendor_row; ?>">
                  ...
                  <span style=""><?php echo $vendor['vsuppliercode']; ?></span>
                    <!-- <input type="text" class="editable" maxlength="20" name="vendor[<?php echo $i; ?>][vsuppliercode]" id="vendor[<?php echo $i; ?>][vsuppliercode]" value="<?php echo $vendor['vsuppliercode']; ?>" onclick='document.getElementById("vendor[<?php echo $vendor_row; ?>][select]").setAttribute("checked","checked");' /> -->
