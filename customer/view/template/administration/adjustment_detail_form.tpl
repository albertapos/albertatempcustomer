                        ...
                        <?php foreach($edit_right_items as $k => $edit_right_item){?>
                          <tr>
                            ...
                            <td class="text-right" style="width:10%;">
                              <input type="text" class="editable nunitcost_class" name="items[<?php echo $k; ?>][nunitcost]" value="<?php echo $edit_right_item['nunitcost']; ?>" style="width:40px;text-align: right;">
                            </td>
                            <td class="text-right" style="width:10%;">
                              <input type="text" class="editable npackqty_class" name="items[<?php echo $k; ?>][npackqty]" value="<?php echo $edit_right_item['npackqty']; ?>" style="width:40px;text-align: right;">
                            </td>
                            <td class="text-right" style="width:10%;">
                              <input type="text" class="editable ndebitqty_class" name="items[<?php echo $k; ?>][ndebitqty]" value="<?php echo $edit_right_item['ndebitqty']; ?>" style="width:40px;text-align: right;">
                            </td>
                            <td style="width:10%;">
                                <select name="items[<?php echo $k; ?>][vreasoncode]" style="width:45px;">
                            ...
                            <td class="text-right" style="width:10%;">
                              <input type="text" class="editable itotalunit_class" name="items[<?php echo $k; ?>][itotalunit]" value="<?php echo $edit_right_item['itotalunit']; ?>" style="width:40px;text-align: right;">
                            </td>
                            <td class="text-right" style="width:10%;">
    ...
    $.ajax({
      ...
      if(response.right_items_arr){
        ...
        $.each(response.right_items_arr, function(i, v) {
          ...
          right_items_html += '<td class="text-right" style="width:10%;">'+v.npack+'<input type="hidden" class="editable npackqty_class" name="items['+window.index_item+'][npackqty]" id="" value="'+v.npack+'" style="width:40px;text-align:right;"></td>';
          right_items_html += '<td class="text-right" style="width:10%;"><input type="text" class="editable_all_selected ndebitqty_class" name="items['+window.index_item+'][ndebitqty]" id="" style="width:40px;text-align:right;" value="0.00"></td>';
          
          right_items_html += '<td style="width:10%;">';
          
          right_items_html += '<select name="items['+window.index_item+'][vreasoncode]" style="width:45px;">';
          ...
          right_items_html += '</td>';
          right_items_html += '<td class="text-right" style="width:10%;"><span class="text_itotalunit_class">0.00</span><input type="hidden" class="editable itotalunit_class" name="items['+window.index_item+'][itotalunit]" id="" value="0.00" style="width:40px;text-align:right;"></td>';
    ...
    $.getJSON(display_items_url, function(result){
      ...
      if(result.edit_right_items){
        ...
        //   right_items_html += '<td class="text-right" style="width:10%;"><span class="text_itotalunit_class">'+ v.itotalunit +'</span><input type="hidden" class="editable itotalunit_class" name="items['+window.index_item+'][itotalunit]" value="'+v.itotalunit+'" id="" style="width:40px;text-align:right;"></td>';
          right_items_html += '<td class="text-right" style="width:10%;"><span class="text_itotalunit_class">'+ v.ndebitqty +'</span><input type="hidden" class="editable itotalunit_class" name="items['+window.index_item+'][itotalunit]" value="'+v.itotalunit+'" id="" style="width:40px;text-align:right;"></td>';
