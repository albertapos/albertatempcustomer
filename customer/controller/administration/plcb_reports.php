  ...
  public function pdf_save_page() {
    ...
    $data['pdf_save_page'] = $this->url->link('administration/plcb_reports/pdf_save_page', 'token=' . $this->session->data['token'] . $url, true);
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            $data['selected_month'] = $this->request->post['month'];
            
            $text = "POST ".$data['selected_month'];
            
            // $start_date_string = "first day of ". $data['selected_month'] ." ".date('Y', strtotime('now'));
            // $start_date = date('Y-m-d', strtotime($start_date_string));
            
            //die($start_date_string.": ".$start_date);
      
            $buckets = $this->model_api_plcb_reports->getBuckets();

		    $mst_plcb_items = $this->model_api_plcb_reports->getMstPlcbItems($this->request->post['month']);    
        ...
        $sch_c_mst_plcb_item_details = $this->model_administration_plcb_reports->getMstPlcbItemDetailsScheduleC($data['selected_month']);
