  ...
  public function pdf_save_page() {
    ...
    if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
      ...
      if($this->request->post['report_by'] == 1){
        $data['reports'] = $this->model_api_zero_movement_report->getCategoriesReport($this->request->post);
      }elseif($this->request->post['report_by'] == 2){
        $data['reports'] = $this->model_api_zero_movement_report->getZeroMovementReport($this->request->post);
      }else{
         $data['reports'] = $this->model_api_zero_movement_report->getGroupsReport($this->request->post);
      }
    ...
    $data['report_ajax_data'] = $this->url->link('administration/zero_movement_report/report_ajax_data', 'token=' . $this->session->data['token'] . $url, true);
    ...
    $data['csv_export'] = $this->url->link('administration/zero_movement_report/csv_export', 'token=' . $this->session->data['token'] . $url, true);
