<?php
class ControllerAdministrationItemsEditItems extends Controller {
	private $error = array();
	...
	public function edit_list() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
			...
			$this->response->redirect($this->url->link('administration/items/edit_items', 'token=' . $this->session->data['token'] . $url, true));
		}
	}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('administration/items/edit_items', 'token=' . $this->session->data['token'] . $url, true)
		);

		$data['add'] = $this->url->link('administration/items/edit_items/add', 'token=' . $this->session->data['token'] . $url, true);
		$data['edit'] = $this->url->link('administration/items/edit_items/edit', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('administration/items/edit_items/delete', 'token=' . $this->session->data['token'] . $url, true);
		$data['edit_list'] = $this->url->link('administration/items/edit_items/edit_list', 'token=' . $this->session->data['token'] . $url, true);
		$data['searchitem'] = $this->url->link('administration/items/edit_items/search', 'token=' . $this->session->data['token'] . $url, true);
		$data['current_url'] = $this->url->link('administration/items/edit_items', 'token=' . $this->session->data['token'] . $url, true);
		$data['add_remove_ids_url'] = $this->url->link('administration/items/edit_items/add_remove_ids', 'token=' . $this->session->data['token'] . $url, true);
		$data['unset_session_value'] = $this->url->link('administration/items/edit_items/unset_session_value', 'token=' . $this->session->data['token'] . $url, true);
		$data['get_session_value'] = $this->url->link('administration/items/edit_items/get_session_value', 'token=' . $this->session->data['token'] . $url, true);
		$data['set_unset_session_value'] = $this->url->link('administration/items/edit_items/set_unset_session_value', 'token=' . $this->session->data['token'] . $url, true);
		...
		$item_data_total = $this->model_api_items_edit_items->getTotalItems($filter_data);
		$item_total = $item_data_total['total'];
		$data['items_id_array'] = $item_data_total['iitemid'];
		
		$item_data = $this->model_api_items_edit_items->getItems($filter_data);
		...
		$itemsUnits = $this->model_api_items_edit_items->getItemsUnits();

		$data['itemsUnits'] = $itemsUnits;

		$buckets = $this->model_api_items_edit_items->getBuckets();
		...
		$this->response->setOutput($this->load->view('administration/items/edit_item_list', $data));
	}
