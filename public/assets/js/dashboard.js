jQuery(document).ready(function(){
    ...
    var date  = $('#date').val();
	$.ajax({
		url: 'admin/7daysSales?fdate='+fdate+'&tdate='+tdate,
		type: 'GET',
	...
	$.ajax({
		url: 'admin/7daysCustomer?fdate='+fdate+'&tdate='+tdate,
		type: 'GET',
		success: function(result) {
			var arr = result.data;
			var newCust = new Array();
	...
	$.ajax({
		url: 'admin/topCategory?fdate='+fdate+'&tdate='+tdate,
		type: 'GET',
		success: function(result) {
			var arr = result.data;
			var newCust = new Array();
	...
	// $.ajax({
	// 	url: 'admin/dailySales?fdate='+fdate+'&tdate='+tdate,
	// 	type: 'GET',
	// 	success: function(result) {
	// 		var arr = result.data;
	// 		var newCust = new Array();
 ...
 //            });
	...
	// });
	$.ajax({
		url: 'admin/topItem?fdate='+fdate+'&tdate='+tdate,
		type: 'GET',
		success: function(result) {
			var arr = result.data;
			var newCust = new Array();
	...
	$.ajax({
		url: 'admin/summary?fdate='+tdate+'&tdate='+tdate,
		type: 'GET',
		success: function(result) {
			var arr = result;
			var newCust = new Array();
