...
//dd("mysql -u" . $databaseuser . " -p" . $databasepass . " " . //                $databasename . " < ". storage_path('golden_blank.sql') );

//mysql -uu1070 -pmq0X4zyE1gP0s --host=13.59.208.236  --database=u1070


$dd = exec("mysql -u" . $databaseuser . " -p" . $databasepass . " --host=". $db_host . " --database=". $databasename . " < ". storage_path('golden_blank.sql') );
//dd($dd);
        /*
        $xmlapi = new xmlapi($db_host);  
        $xmlapi->password_auth("".$cpaneluser."","".$cpanelpass."");  
    ...
    public function setDefaultSID()
    {
       ...
       // exec("mysql -u" . $databaseuser . " -p" . $databasepass . " " . //$databasename . " < ". storage_path('web_DefaultPosData.sql') );
        ...
        exec("mysql -u" . $databaseuser . " -p" . $databasepass . " --host=". $db_host . " --database=". $databasename . " < ". storage_path('web_DefaultPosData.sql') );
