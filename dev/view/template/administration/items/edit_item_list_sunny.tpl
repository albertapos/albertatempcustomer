          ...
          <div class="panel-body">
            <form action="<?php echo $current_url;?>" method="post" id="form_item_search">
              <div class="row">
                  ...
                  <div class="col-md-2" style="width:12%;">
                      <input type="radio" name="search_radio" value="supplier">&nbsp;&nbsp;<span style="margin-top:3px;postion:absolute;">Supplier</span>
                  </div>
                  <div class="col-md-2" style="width:12%;">
              ...
              <div class="row">
                  ...
                  <div class="col-md-4" id="div_search_vsuppliercode">
                    <span style="display:inline-block;width:25%;"><b>Supplier</b></span>&nbsp;&nbsp;<select name="search_vsuppliercode" id="search_vsuppliercode" class="form-control" style="display:inline-block;width:60%;">
        ...
        <br>
          ...
          <div class="table-responsive">
            ...
            <?php if ($items) { ?>
              <thead>
                <tr>
                  <th style="width: 1px;" class="text-center"><input type="checkbox" name="selected_items_id[]" id="main_checkbox" value="" onclick="$('input[name*=\'selected_items_id\']').prop('checked', this.checked);" /></th>
...
$(document).ready(function() {
  ...
  <?php }else if(isset($search_radio) && $search_radio == 'department'){ ?>
    ...
    <?php } ?>
  <?php }else if(isset($search_radio) && $search_radio == 'supplier'){ ?>
    $('#div_search_vsuppliercode').show();
    $("input[name=search_radio][value='supplier']").prop('checked', true);
    <?php if(isset($search_find) && !empty($search_find)){ ?>
      var search_find = '<?php echo $search_find; ?>';
      $('#search_vsuppliercode').val(search_find);
    <?php } ?>
...
<script type="text/javascript">
  $(document).on('click', '#update_item_btn', function(event) {
    ...
    var get_session_value_url = '<?php echo $get_session_value; ?>';
  ...
  $(document).on('change', '#main_checkbox', function(event) {
    event.preventDefault();
    var set_unset_session_value_url = '<?php echo $set_unset_session_value; ?>';
