        ...
        <div class="row" style="padding-bottom: 9px;float: right;">
          <div class="col-md-12">
            <div class="">
              ...
              <?php if(isset($clone_item) && $clone_item != ''){?>
                <a href="<?php echo $clone_item; ?>" data-toggle="tooltip" title="Clone Item" class="btn btn-info add_new_btn_rotate"><i class="fa fa-clone"></i>&nbsp;&nbsp;Clone</a>
              <?php } ?>
        ...
        <div class="tab-content responsive">
                  ...
                  <div class="col-sm-8">
                    ...
                    <?php if(isset($edit_page)){?>
                      <?php
                        ...
                        if($iqtyonhand != 0 && $iqtyonhand!='' && $npack!=0){
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    ...
                    <?php if ($error_vdescription) { ?>
                      <div class="text-danger"><?php echo $error_vdescription; ?></div>
                    <?php } ?>
                  </div>
                </div>
              </div>
          ...
          <div style="background:#fff;padding-top:1%;padding-right:1%;">
            ...
            <div class="row">
              <div class="col-md-4">
                  <div class="form-group" style="border-top:none;">
                  <label class="col-sm-4 control-label" for="input-phone"><?php echo $entry_lastcost; ?></label>
                  <div class="col-md-8">
                    <input type="text" name="last_costprice" value="<?php echo isset($last_costprice) ? $last_costprice : ''; ?>" placeholder="<?php echo $entry_lastcost; ?>" id="input-lastcost" class="form-control" readonly/>
                  </div>
                </div>
              </div>
              <div class="col-md-4">
            ...
            <div class="row">
              <div class="col-md-4">
                  ...
                  <label class="col-sm-4 control-label" for="input-phone"><?php echo $entry_newcost; ?></label>
                  <div class="col-md-8">
                    <input type="text" name="new_costprice" value="<?php echo isset($new_costprice) ? $new_costprice : ''; ?>" placeholder="<?php echo $new_costprice; ?>" id="input-new-cost" class="form-control" readonly/>
                  </div>
                </div>
              </div>
          ...
          <div class="tab-pane" id="parent_tab">
            ...
            <div class="row">
              <div class="col-md-4">
                <input type="text" placeholder="Search SKU..." name="search_parent_sku" class="form-control" id="search_parent_sku">
              </div>
            </div>
            <br>
            <div class="row">
                    ...
                    <?php if(isset($itemparentitems) && (count($itemparentitems) > 0)){ ?>
                      <?php foreach($itemparentitems as $itemparentitem){ ?>
                        <tr>
                          ...
                          <td class="text-right"><?php echo $itemparentitem['npack'] ;?></td>
                        </tr>
                      <?php } ?>
                    <?php } ?>
                  </tbody>
                  ...
                  <?php if(isset($itemchilditems) && (count($itemchilditems) > 0)){?>
                    <?php foreach($itemchilditems as $itemchilditem){ ?>
                      <tr>
                        ...
                        <td class="text-right"><?php echo $itemchilditem['npack'] ;?></td>
                      </tr>
                    <?php } ?>
                  <?php } ?>
                  </tbody>
          ...
          <div class="tab-pane" id="lot_matrix_tab">
            ...
            <form action="<?php echo $lot_matrix_editlist; ?>" method="post" enctype="multipart/form-data" id="form-item-lot-matrix-list" class="form-horizontal">
                    ...
                    <?php if(isset($itempacks) && count($itempacks) > 0){ ?>
                      <?php foreach($itempacks as $k => $itempack) { ?>
                        ...
                        <input type="hidden" name="itempacks[<?php echo $k; ?>][idetid]" value="<?php echo $itempack['idetid']; ?>">
                          ...
                          <td class="text-right"><?php echo $nunitcost;?></td>
                          ...
                          <td class="text-right">
                            <input type="text" class="editable input_npackprice" name="itempacks[<?php echo $k; ?>][npackprice]" value="<?php echo $itempack['npackprice']; ?>" style="text-align: right;" />
                          </td>
              ...
              <div class="row">
                <div class="col-md-12">
                  <input type="submit" title="Update" class="btn btn-primary save_btn_rotate" value="Update" <?php if(isset($itempacks) && count($itempacks) == 0){ ?> disabled="true" <?php } ?> >
                </div>
              </div>
            </form>
          </div>
          <div class="tab-pane" id="vendor_tab">
            ...
            <form action="<?php echo $action_vendor_editlist; ?>" method="post" enctype="multipart/form-data" id="form-item-vendor-list" class="form-horizontal">
              ...
              <div class="row">
                <div class="col-md-12">
                  <input type="submit" title="Update" value="Update" class="btn btn-primary save_btn_rotate" <?php if(isset($itemvendors) && count($itemvendors) == 0){ ?> disabled="true" <?php } ?> >
                </div>
              </div>
            </form>
          </div>
          <div class="tab-pane" id="slab_price_tab">
            ...
            <?php } ?>
                    ...
                    <?php if(isset($itemslabprices) && count($itemslabprices) > 0){ ?>
                      <?php foreach($itemslabprices as $k => $itemslabprice) { ?>
                        ...
                        <input type="hidden" name="itemslabprices[<?php echo $k; ?>][islabid]" value="<?php echo $itemslabprice['islabid']; ?>">
                          ...
                          <td class="text-right">
                            <input type="text" class="editable slab_price_iqty" name="itemslabprices[<?php echo $k; ?>][iqty]" value="<?php echo $itemslabprice['iqty']; ?>" style="text-align: right;" />
                          </td>
                          <td class="text-right">
                            <input type="text" class="editable slab_price_nprice" name="itemslabprices[<?php echo $k; ?>][nprice]" value="<?php echo $itemslabprice['nprice']; ?>" style="text-align: right;" />
                          </td>
                          <td class="text-right">
                            <span class="slab_price_nunitprice"><?php echo $itemslabprice['nunitprice'];?> </span> 
                            <input type="hidden" class="input_slab_price_nunitprice" name="itemslabprices[<?php echo $k; ?>][nunitprice]" value="<?php echo $itemslabprice['nunitprice']; ?>" style="text-align: right;" /> 
                          </td>
                        </tr>
                      <?php } ?>
                    <?php } ?>
              ...
              <div class="row">
                <div class="col-md-12">
                  <input type="submit" title="Update" value="Update" class="btn btn-primary save_btn_rotate" <?php if(isset($itemslabprices) && count($itemslabprices) == 0){ ?> disabled="true" <?php } ?> >
                </div>
              </div>
            </form>
          </div>
            ...
            source: function(req, add) {
                $.getJSON(url, req, function(data) {
                    ...
                    $.each(data, function(i, val) {
                      var present_iitemid = "<?php echo $iitemid; ?>";
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        if(data.error){
          ...
          setTimeout(function(){
            var url_redirect = '<?php echo $current_url; ?>';
...
<script type="text/javascript">
  $(document).on('click', '#form-item-vendor-submit-btn', function(event) {
    ...
    var check_vendor_item_code_url = '<?php echo $check_vendor_item_code; ?>';
...
<script type="text/javascript">
  $(document).on('click', '#delete_item_vendor_btn', function(event) {
    event.preventDefault();
    var delete_vendor_code_url = '<?php echo $delete_vendor_code; ?>';
