        ...
        <div class="row">
		  ...
		  <tr style="border-bottom:1px solid #999;">
			<td valign="top">
				<table width="100%" border="0" cellspacing="5" cellpadding="0" style="border-bottom:1px solid #999;">
				  ...
				  <tr style="line-height:25px;">
					<td width="50%" align="left"><strong>Store Name: </strong>Vijay Stores</td>
					<td width="25%" align="right"><strong>Status</strong></td>
					<td>&nbsp;&nbsp;Open</td>
				  </tr>
				  <tr style="line-height:25px;">
					<td width="50%" align="left"><strong>Store Address: </strong>123, Wellington Street</td>
				  ...
				  <tr style="line-height:25px;">
					<td width="50%" align="left"><strong>Store Phone: </strong>8886669999</td>
		  ...
		  <tr style="border-bottom:1px solid #999;">
			<td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:5px 0px;">
			  <tr>
				...
				<td width="20%" align="right" style="padding-bottom:5px;">19.9</td>
			  </tr>
			  <tr style="border-top:1px solid #999;">
				...
				<td width="20%" align="right" style="padding-top:5px;padding-bottom:5px;">1.37</td>
			  </tr>
			  <tr style="border-top:1px solid #999;border-bottom:1px solid #999;">
				...
				<td width="10%" style="padding-top:5px;padding-bottom:5px;">&nbsp;</td>
				<td width="20%" align="right" style="padding-top:5px;padding-bottom:5px;">21.27</td>
			  </tr>
			</table></td>
		  </tr>
		  <tr style="border-top:1px solid #999;border-bottom:1px solid #999;">
			<td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:5px 0px;"><tr>
						...
						<td width="20%" align="right">21.27</td>
					  </tr></table></td>
		  </tr>
		  <tr>
		  ...
		  <tr>
			<td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:5px 0px;display:none;">
			  ...
			  <tr>
				<td align="left"><strong>TRN : </strong>1809191012</td>
				<td>&nbsp;</td>
				<td align="left">&nbsp;</td>
			  </tr>
			  <tr>
				<td align="left"><strong>TRN Time : </strong>09-19-2018 06:18 PM</td>
				<td>&nbsp;</td>
				<td align="left">&nbsp;</td>
			  </tr>
			</table></td>
