            ...
            <table class="table table-bordered table-striped table-hover" style="border:none;width:80%;">
              ...
              <tbody>
                ...
                <?php foreach ($reports as $key => $value){ ?>
                  ...
                  <td colspan="8" style="padding:0px"><table class="table" style="margin-top: 3px;margin-bottom: 3px;">
                  <thead><th colspan="8" class="text-uppercase header" style="cursor: pointer;"><?php echo $key; ?> <span class="sign"></span></th></thead>
                  ...
                  ?>
                    <tr >
                      <td style="width: 20%;"><?php echo $v['suppliername'];?></td>
                      <td style="width: 10%;"><?php echo $v['vname'];?></td>
                      <td style="width: 20%;"><?php echo $v['itemname'];?></td>
                      <td style="width: 10%;" class="text-right"><?php echo $v['iqtyonhand'];?></td>
                      <td style="width: 10%;" class="text-right"><?php echo number_format((float)$v['cost'], 2, '.', '') ;?></td>
                      <td style="width: 10%;" class="text-right"><?php echo number_format((float)$tot_value, 2, '.', '') ;?></td>
                      <td style="width: 10%;" class="text-right"><?php echo number_format((float)$v['price'], 2, '.', '') ;?></td>
                      <td style="width: 10%;" class="text-right"><?php echo number_format((float)$tot_ret_value, 2, '.', '') ;?></td>
                    </tr>
                  <?php } ?>
                  <tr >
                    <td style="width: 20%;"></td>
                    <td style="width: 10%;"></td>
                    <td style="width: 20%;" class="text-right"><b>Total</b></td>
                    <td style="width: 10%;" class="text-right"><b><?php echo $total_qty;?></b></td>
                    <td style="width: 10%;"></td>
                    <td style="width: 10%;" class="text-right"><b>$ <?php echo number_format((float)$total_total_value, 2) ;?></b></td>
                    <td style="width: 10%;" class="text-right"></td>
                    <td style="width: 10%;" class="text-right"><b>$ <?php echo number_format((float)$total_total_retail_value, 2) ;?></b></td>
                  </tr>
                  </tbody></table></td></tr>
                <?php } ?>
                  <tr class="add_space"><th></th></tr>
