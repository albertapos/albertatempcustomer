...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <form action="<?php echo $current_url;?>" method="post" id="form_aisle_search">
        <input type="hidden" name="searchbox" id="Id">
        <div class="row">
            <div class="col-md-12">
                <input type="text" name="automplete-product" class="form-control" placeholder="Search Aisle..." id="automplete-product">
            </div>
        </div>
      </form>
       <br>
        ...
        <form action="" method="post" enctype="multipart/form-data" id="form-aisle">
          ...
          <?php if ($aisles) { ?>
            <table id="aisle" class="text-center table table-bordered table-hover" style="width:50%;">
              ...
              <tbody>
                <?php $aisle_row = 1;$i=0; ?>
                <?php foreach ($aisles as $k => $aisle) { ?>
                  <tr>
                    <td class="text-center">
                      <input type="checkbox" name="selected[]" id="aisle[<?php echo $k; ?>][select]"  value="<?php echo $aisle['Id']; ?>" />
                    </td>
                    
                    <td class="text-left">
                    <span style="display:none;"><?php echo $aisle['aislename']; ?></span>
                    <input type="text" maxlength="45" class="editable aisle_c" name="aisle[<?php echo $k; ?>][aislename]" id="aisle[<?php echo $k; ?>][aislename]" value="<?php echo $aisle['aislename']; ?>" onclick='document.getElementById("aisle[<?php echo $k; ?>][select]").setAttribute("checked","checked");' />
          				  <input type="hidden" name="aisle[<?php echo $k; ?>][Id]" value="<?php echo $aisle['Id']; ?>"/>
          				  </td>
                  </tr>
                <?php $aisle_row++; $i++;?>
                <?php } ?>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?php echo $edit_list; ?>" method="post" id="add_new_form">
            <input type="hidden" name="aisle[0][Id]" value="0">
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div class="col-md-10">  
                    <input name="aisle[0][aislename]" maxlength="45" id="add_aislename" class="form-control">
                  </div>
                </div>
              </div>
            </div>
