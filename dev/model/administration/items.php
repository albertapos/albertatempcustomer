...
class ModelAdministrationItems extends Model {
    ...
    public function getDepartments() {
        $query = $this->db2->query("SELECT * FROM mst_department")->rows;
        return $query;
    }

    public function getCategories() {
        $query = $this->db2->query("SELECT * FROM mst_category")->rows;
        return $query;
    }
    ...
    public function getSuppliers() {
        $query = $this->db2->query("SELECT * FROM mst_supplier")->rows;
        return $query;
    }
    ...
    public function getItemGroups() {
        $query = $this->db2->query("SELECT * FROM itemgroup")->rows;
        return $query;
    }
