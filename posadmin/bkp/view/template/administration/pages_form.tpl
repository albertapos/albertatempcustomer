...
function addPages() {
	...
	//{
		...
		html += '  <td class="text-left"><button type="button" onclick="$(\'#pages-row' + pages_row + '\').remove();" data-toggle="tooltip" title="Remove" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>';
		html += '</tr>';
	//}
