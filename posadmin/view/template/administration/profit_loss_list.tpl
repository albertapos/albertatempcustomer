    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
          <br>
            <table class="table table-bordered table-striped table-hover" style="border:none;width:85%;">
              <thead>
              ...
              <tbody>
                  ...
                  <?php foreach ($reports as $key => $value){ ?>
                    ...
                    <?php $product_count_markup++;} $total_mark_up = $total_mark_up/$product_count_markup; ?>
                    <tr>
                      <td><b>Sub Total</b></td>
                      <td>&nbsp;&nbsp;</td>
                      <td>&nbsp;&nbsp;</td>
                  ...
                  <?php $grand_markup_count++;} $grand_total_mark_up=$grand_total_mark_up/$grand_markup_count;  ?>
                  <tr>
