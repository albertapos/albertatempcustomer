...
class ModelAdministrationVendor extends Model {
	...
	public function addVendor($data) {
		...
		$this->db2->query("INSERT INTO mst_supplier SET  vcompanyname = '" . $this->db->escape($data['vcompanyname']) . "',`vvendortype` = '" . $this->db->escape($data['vvendortype']) . "', vfnmae = '" . $this->db->escape($data['vfnmae']) . "',`vlname` = '" . $this->db->escape($data['vlname']) . "',`vcode` = '" . $this->db->escape($data['vcode']) . "', vaddress1 = '" . $this->db->escape($data['vaddress1']) . "', vcity = '" . $this->db->escape($data['vcity']) . "', vstate = '" . $this->db->escape($data['vstate']) . "', vphone = '" . $this->db->escape($data['vphone']) . "', vzip = '" . $this->db->escape($data['vzip']) . "', vcountry = '" . $this->db->escape($data['vcountry']) . "', vemail = '" . $this->db->escape($data['vemail']) . "', estatus = '" . $this->db->escape($data['estatus']) . "',SID = '" . (int)($this->session->data['SID'])."'");

		$isupplierid = $this->db->getLastId();
	...
	public function editVendor($isupplierid, $data) {
		...
		$this->db2->query("UPDATE mst_supplier SET  vcompanyname = '" . $this->db->escape($data['vcompanyname']) . "',`vvendortype` = '" . $this->db->escape($data['vvendortype']) . "', vfnmae = '" . $this->db->escape($data['vfnmae']) . "',`vlname` = '" . $this->db->escape($data['vlname']) . "',`vcode` = '" . $this->db->escape($data['vcode']) . "', vaddress1 = '" . $this->db->escape($data['vaddress1']) . "', vcity = '" . $this->db->escape($data['vcity']) . "', vstate = '" . $this->db->escape($data['vstate']) . "', vphone = '" . $this->db->escape($data['vphone']) . "', vzip = '" . $this->db->escape($data['vzip']) . "', vcountry = '" . $this->db->escape($data['vcountry']) . "', vemail = '" . $this->db->escape($data['vemail']) . "', estatus = '" . $this->db->escape($data['estatus']) . "' WHERE isupplierid = '" . (int)$isupplierid . "'");
