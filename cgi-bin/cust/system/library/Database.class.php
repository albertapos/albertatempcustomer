...
$somecontent="Database Error"."\r\n";
$somecontent.="Message:".$msg."\r\n";
if(strlen($this->error)>0)
{
	$somecontent.="MySQL Error:".$this->error."\r\n";
	$somecontent.="Date:".date("l, F j, Y \a\\t g:i:s A")."\r\n";
	$somecontent.="Script:".$_SERVER['REQUEST_URI']."\r\n";
	if(strlen(@$_SERVER['HTTP_REFERER'])>0)
	{ 
		$somecontent.="Referer:".$_SERVER['HTTP_REFERER']."\r\n";
	}
}
$somecontent.="\r\n";
//echo $somecontent;
...
//$db2 = new Database($this->session->data['db_hostname2'], $this->session->data['db_username2'], $this->session->data['db_password2'], $this->session->data['db_database2']);
//$db2->connect();
