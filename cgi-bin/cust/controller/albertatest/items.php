<?php
class ControllerAlbertatestItems extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('albertatest/items');
	...
	public function add() {
		...
		$this->load->model('albertatest/items');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->model_albertatest_items->addItems($temp_arr);
			...
			$this->response->redirect($this->url->link('albertatest/items', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	public function clone_item() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$last_iitemid = $this->model_albertatest_items->addItems($temp_arr);
	...
	public function action_vendor() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
			...
			$this->model_albertatest_items->addUpdateItemVendor($temp_arr);
			...
			$this->response->redirect($this->url->link('albertatest/items/edit', 'token=' . $this->session->data['token'] . $url, true));
		}
	}
	...
	public function lot_matrix_editlist() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
			...
			$this->model_albertatest_items->editlistLotMatrixItems($temp_arr);
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
			...
			if(isset($this->request->post['itemvendors']) && count($this->request->post['itemvendors']) > 0){
				foreach ($this->request->post['itemvendors'] as $key => $value) {
					$this->model_albertatest_items->addUpdateItemVendor($value);
				}
			}
	...
	public function slab_price_editlist() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
			...
			$this->model_albertatest_items->editlistSlabPriceItems($this->request->post['itemslabprices']);
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->model_albertatest_items->editlistItems($temp_arr['iitemid'],$temp_arr);
	...
	protected function getList() {
		...
		$data['add'] = $this->url->link('albertatest/items/add', 'token=' . $this->session->data['token'] . $url, true);
		$data['edit'] = $this->url->link('albertatest/items/edit', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('albertatest/items/delete', 'token=' . $this->session->data['token'] . $url, true);
		$data['edit_list'] = $this->url->link('albertatest/items/edit_list', 'token=' . $this->session->data['token'] . $url, true);
		$data['searchitem'] = $this->url->link('albertatest/items/search', 'token=' . $this->session->data['token'] . $url, true);
		$data['current_url'] = $this->url->link('albertatest/items', 'token=' . $this->session->data['token'], true);
		$data['import_items'] = $this->url->link('albertatest/items/import_items', 'token=' . $this->session->data['token'] . $url, true);
		$data['get_barcode'] = $this->url->link('albertatest/items/get_barcode', 'token=' . $this->session->data['token'] . $url, true);
		...
		$itemListings = $this->model_albertatest_items->getItemListings();
		...
		$item_data = $this->model_albertatest_items->getItemsResult($filter_data);

		$item_total = $this->model_albertatest_items->getTotalItems($filter_data);
		...
		if(count($data['itemListings']) > 0){
			foreach ($results as $k => $result) {
				...
				$data['items'][$k]['edit'] = $this->url->link('albertatest/items/edit', 'token=' . $this->session->data['token'] . '&iitemid=' . $result['iitemid'] . $url, true);
				$data['items'][$k]['clone_item'] = $this->url->link('albertatest/items/clone_item', 'token=' . $this->session->data['token'] . '&iitemid=' . $result['iitemid'] . $url, true);
			}
			...
			foreach ($results as $result) {
				...
				$data['items'][] = array(
					...
					'edit'          => $this->url->link('albertatest/items/edit', 'token=' . $this->session->data['token'] . '&iitemid=' . $result['iitemid'] . $url, true),
					'clone_item'          => $this->url->link('albertatest/items/clone_item', 'token=' . $this->session->data['token'] . '&iitemid=' . $result['iitemid'] . $url, true)
				);
			}
		}
		...
		$data['item_sorting'] = $this->url->link('albertatest/items', 'token=' . $this->session->data['token'] . $url1, true);
		...
		$pagination->url = $this->url->link('albertatest/items', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('albertatest/item_list', $data));
	}
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['iitemid'])) {
			$data['action'] = $this->url->link('albertatest/items/add', 'token=' . $this->session->data['token'] . $url, true);

			$data['clone_item'] = '';
		} else {
			$data['action'] = $this->url->link('albertatest/items/edit', 'token=' . $this->session->data['token'] . '&iitemid=' . $this->request->get['iitemid'] . $url, true);

			$data['clone_item'] = $this->url->link('albertatest/items/clone_item', 'token=' . $this->session->data['token'] . '&iitemid=' . $this->request->get['iitemid'] . $url, true);
		}

		$data['delete'] = $this->url->link('albertatest/items/delete', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete_vendor_code'] = $this->url->link('albertatest/items/delete_vendor_code', 'token=' . $this->session->data['token'] . $url, true);
		$data['current_url'] = $this->url->link('albertatest/items', 'token=' . $this->session->data['token'], true);

		$data['action_vendor'] = $this->url->link('albertatest/items/action_vendor', 'token=' . $this->session->data['token'] . $url, true);
		$data['action_vendor_editlist'] = $this->url->link('albertatest/items/action_vendor_editlist', 'token=' . $this->session->data['token'] . $url, true);
		...
		$data['lot_matrix_editlist'] = $this->url->link('albertatest/items/lot_matrix_editlist', 'token=' . $this->session->data['token'] . $url, true);
		...
		$data['slab_price_editlist'] = $this->url->link('albertatest/items/slab_price_editlist', 'token=' . $this->session->data['token'] . $url, true);
		...
		$data['check_vendor_item_code'] = $this->url->link('albertatest/items/check_vendor_item_code', 'token=' . $this->session->data['token'] . $url, true);
		...
		$data['cancel'] = $this->url->link('albertatest/items', 'token=' . $this->session->data['token'] . $url.'&cancel_btn=yes', true);

		$this->load->model('albertatest/items');

		if (isset($this->request->get['iitemid']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$item_info = $this->model_albertatest_items->getItem($this->request->get['iitemid']);
			...
			$unit_data = $this->model_albertatest_items->getItemUnitData($this->request->get['iitemid']);
			$bucket_data = $this->model_albertatest_items->getItemBucketData($this->request->get['iitemid']);
		}
		...
		if (isset($this->request->post['vtax1'])) {
			...
			$item_tax1_info = $this->model_albertatest_items->getStoreSettingTax1();
		...
		$loadChildProducts = $this->model_albertatest_items->getChildProductsLoad();

		$data['loadChildProducts'] = $loadChildProducts;

		$itemsUnits = $this->model_albertatest_items->getItemsUnits();

		$data['itemsUnits'] = $itemsUnits;

		$buckets = $this->model_albertatest_items->getBuckets();
		...
		$this->response->setOutput($this->load->view('albertatest/item_form', $data));
	}
	...
	protected function getCloneForm() {
		...
		$data['action'] = $this->url->link('albertatest/items/clone_item', 'token=' . $this->session->data['token'] . $url, true);
		...
		$item_info = $this->model_albertatest_items->getItem($clone_item_id);

		$unit_data = $this->model_albertatest_items->getItemUnitData($clone_item_id);
        $bucket_data = $this->model_albertatest_items->getItemBucketData($clone_item_id);
		...
		$this->response->setOutput($this->load->view('albertatest/clone_item_form', $data));
	}
  	...
  	protected function validateForm() {
		...
		if(isset($this->request->get['iitemid']) && $this->request->get['iitemid'] != ''){
			...
			if($item_info['vbarcode'] != $this->request->post['vbarcode']){
				$unique_sku = $this->model_albertatest_items->getSKU($this->request->post['vbarcode']);
	...
	public function search() {
		...
		if(isset($this->request->get['term']) && !empty($this->request->get['term'])){
			...
			$datas = $this->model_albertatest_items->getItemsSearchResult($this->request->get['term']);
	...
	public function import_items(){
		...
		if ($this->request->server['REQUEST_METHOD'] == 'POST' && isset($this->request->files['import_item_file']) && $this->request->files['import_item_file']['name'] != '') {
			...
			if ($handle) {
					...
					if($line_row_index != 1){
						if(count($values) != 10){
							...
							if(strlen($itemcode) > 0 && strlen($itemname)){
								$checkItemCode = $this->model_albertatest_items->getSKU($itemcode);
								...
								if(count($checkItemCode) == 0){
	                                ...
	                                $this->model_albertatest_items->addImportItems($data);
				...
				$file_path = DIR_TEMPLATE."/albertatest/import-item-status-report.txt";

				$myfile = fopen( DIR_TEMPLATE."/albertatest/import-item-status-report.txt", "w");
	...
	public function delete() {
		...
		if ($this->request->server['REQUEST_METHOD'] == 'POST') {
			...
			$data = $this->model_albertatest_items->deleteItems($temp_arr);
	...
	public function get_barcode() {
		...
		if(!empty($this->request->get['vbarcode'])){
			...
			$json = $this->model_albertatest_items->getItemByBarcode($this->request->get['vbarcode']);
	...
	public function check_vendor_item_code() {
		...
		if ($this->request->server['REQUEST_METHOD'] == 'POST') {
			...
			$data = $this->model_albertatest_items->checkVendorItemCode($temp_arr);
	...
	public function delete_vendor_code() {
		...
		if ($this->request->server['REQUEST_METHOD'] == 'POST') {
			...
			$data = $this->model_albertatest_items->deleteVendorItemCode($temp_arr);
