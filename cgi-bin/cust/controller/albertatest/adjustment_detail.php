<?php
class ControllerAlbertatestAdjustmentDetail extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('albertatest/adjustment_detail');
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
			...
			$this->response->redirect($this->url->link('albertatest/adjustment_detail', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('albertatest/adjustment_detail', 'token=' . $this->session->data['token'] . $url, true)
		);

		$data['add'] = $this->url->link('albertatest/adjustment_detail/add', 'token=' . $this->session->data['token'] . $url, true);
		$data['edit'] = $this->url->link('albertatest/adjustment_detail/edit', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('albertatest/adjustment_detail/delete', 'token=' . $this->session->data['token'] . $url, true);
		$data['edit_list'] = $this->url->link('albertatest/adjustment_detail/edit_list', 'token=' . $this->session->data['token'] . $url, true);

		$data['current_url'] = $this->url->link('albertatest/adjustment_detail', 'token=' . $this->session->data['token'], true);
		$data['searchadjustment'] = $this->url->link('albertatest/adjustment_detail/search', 'token=' . $this->session->data['token'], true);
		...
		foreach ($results as $result) {
			...
			$data['adjustment_details'][] = array(
				...
				'edit'            => $this->url->link('albertatest/adjustment_detail/edit', 'token=' . $this->session->data['token'] . '&ipiid=' . $result['ipiid'] . $url, true)
		...
		$pagination->url = $this->url->link('albertatest/adjustment_detail', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('albertatest/adjustment_detail_list', $data));
	}
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['ipiid'])) {
			$data['action'] = $this->url->link('albertatest/adjustment_detail/add', 'token=' . $this->session->data['token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('albertatest/adjustment_detail/edit', 'token=' . $this->session->data['token'] . '&ipiid=' . $this->request->get['ipiid'] . $url, true);
		}

		$data['cancel'] = $this->url->link('albertatest/adjustment_detail', 'token=' . $this->session->data['token'] . $url, true);
		$data['add_items'] = $this->url->link('albertatest/adjustment_detail/add_items', 'token=' . $this->session->data['token'] . $url, true);
		$data['remove_items'] = $this->url->link('albertatest/adjustment_detail/remove_items', 'token=' . $this->session->data['token'] . $url, true);

		$data['display_items'] = $this->url->link('albertatest/adjustment_detail/display_items', 'token=' . $this->session->data['token'], true);
		$data['display_items_search'] = $this->url->link('albertatest/adjustment_detail/display_items_search', 'token=' . $this->session->data['token'], true);
		$data['calculate_post'] = $this->url->link('albertatest/adjustment_detail/calculate_post', 'token=' . $this->session->data['token'], true);
		$data['adjustment_list'] = $this->url->link('albertatest/adjustment_detail', 'token=' . $this->session->data['token'], true);
		...
		$this->response->setOutput($this->load->view('albertatest/adjustment_detail_form', $data));
	}
