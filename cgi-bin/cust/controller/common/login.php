...
class ControllerCommonLogin extends Controller {
	...
	public function index() {
		...
		if ($this->user->isLogged() && isset($this->request->get['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
			...
			$this->response->redirect($this->url->link('common/dashboard/dashboard_quick_links', 'token=' . $this->session->data['token'], true));
		}
//echo $this->request->get['sid'];
	...
	protected function validate() {
		if (!isset($this->request->post['username']) || !isset($this->request->post['password']) || !$this->user->login($this->request->post['username'], html_entity_decode($this->request->post['password']))) {
