...
class ControllerKioskMenus extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_kiosk_menus->addMenus($this->request->post);
	...
	public function edit() { 
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_kiosk_menus->editMenus($this->request->get['MenuId'], $this->request->post);
	...
	public function edit_list() { 
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
			$this->model_kiosk_menus->editMenusList($this->request->post);
	...
	protected function getForm() {
		...
		if (isset($this->request->post['ImageLoc'])) {
			...
			$data['ImageLoc'] = $category_info['ImageLoc'];
		} else {
			$data['ImageLoc'] = '';
		}
