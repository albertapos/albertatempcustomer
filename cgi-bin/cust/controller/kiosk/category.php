...
class ControllerKioskCategory extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_kiosk_category->addCategory($this->request->post);
	...
	public function edit() { 
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_kiosk_category->editCategory($this->request->get['CategoryId'], $this->request->post);
	...
	public function edit_list() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateEditList()) {
			$this->model_kiosk_category->editCategoryList($this->request->post['MenuId'], $this->request->post);
