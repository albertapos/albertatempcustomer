        ...
        if(count($data['reports']) > 0){
            ...
            foreach ($data['reports'] as $key => $value) {
              ...
              foreach ($value as $k => $v){
                ...
                $tot_ret_value = $v['iqtyonhand'] * number_format((float)($v['price']/$v['nsellunit']), 2, '.', '');
                ...
                $data_row .= str_replace(',',' ',$v['vname']).','.str_replace(',',' ',$v['itemname']).','.$v['iqtyonhand'].','.number_format((float)$v['cost'], 2, '.', '').','. number_format((float)$tot_value, 2, '.', '').','.number_format((float)($v['price']/$v['nsellunit']), 2, '.', '').','.number_format((float)$tot_ret_value, 2, '.', '') .PHP_EOL;
              }
    ...
    if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
      ...
      foreach ($reportsdata as $k => $v) {
        ...
        if(array_key_exists($v['search_id'],$report_datas)){
            $report_datas[$v['search_id']]['key_name'] = $v['search_name'];
            $report_datas[$v['search_id']]['key_id'] = $v['search_id'];
            $report_datas[$v['search_id']]['search_total_qoh'] = $report_datas[$v['search_id']]['search_total_qoh'] + $v['iqtyonhand'];

            $report_datas[$v['search_id']]['search_total_cost_price'] = $report_datas[$v['search_id']]['search_total_cost_price'] + $v['cost'];
            $report_datas[$v['search_id']]['search_total_total_cost_price'] = $report_datas[$v['search_id']]['search_total_total_cost_price'] + ($v['iqtyonhand'] * number_format($v['cost'],2));
            ...
            $report_datas[$v['search_id']]['search_total_total_retail_value'] = $report_datas[$v['search_id']]['search_total_total_retail_value'] + ($v['iqtyonhand'] * ($v['price']/$v['nsellunit']));

        }else{
            $report_datas[$v['search_id']]['key_name'] = $v['search_name'];
            $report_datas[$v['search_id']]['key_id'] = $v['search_id'];
            $report_datas[$v['search_id']]['search_total_qoh'] = $v['iqtyonhand'];

            $report_datas[$v['search_id']]['search_total_cost_price'] = $v['cost'];
            $report_datas[$v['search_id']]['search_total_total_cost_price'] = ($v['iqtyonhand'] * number_format($v['cost'],2));
            $report_datas[$v['search_id']]['search_total_retail_value'] = ($v['price']/$v['nsellunit']);
            $report_datas[$v['search_id']]['search_total_total_retail_value'] = ($v['iqtyonhand'] * ($v['price']/$v['nsellunit']));
        }

        $total_qoh = $total_qoh + $v['iqtyonhand'];
        $toal_cost_price = $toal_cost_price + $v['cost'];
        $toal_value = $toal_value + ($v['iqtyonhand'] * number_format($v['cost'],2));

        $total_retail = $total_retail + ($v['price']/$v['nsellunit']);
        $total_retail_value = $total_retail_value + ($v['iqtyonhand'] * ($v['price']/$v['nsellunit']));
      }
    ...
    if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
      ...
      foreach ($reportsdata as $k => $v) {
        ...
        if(array_key_exists($v['search_name'],$report_datas)){
            ...
            $report_datas[$v['search_name']]['search_total_retail_value'] = $report_datas[$v['search_name']]['search_total_retail_value'] + ($v['price']/$v['nsellunit']);
            ...
            $report_datas[$v['search_name']]['search_total_retail_value'] = ($v['price']/$v['nsellunit']);
  ...
  protected function getList_test() {
    ...
    if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
      ...
      foreach ($reportsdata as $k => $v) {
        ...
        $total_retail = $total_retail + ($v['price']/$v['nsellunit']);
        $total_retail_value = $total_retail_value + ($v['iqtyonhand'] * number_format((float)($v['price']/$v['nsellunit']), 2, '.', ''));
      }
        ...
        foreach ($report_datas as $key => $value) {
          ...
          if(count($value) > 0){
            ...
            foreach ($value as $k => $v) {
              ...
              $temp[0]['total_price'] = ($v['price']/$v['nsellunit']) * $v['iqtyonhand'];
