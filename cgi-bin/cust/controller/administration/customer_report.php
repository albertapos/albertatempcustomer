...
class ControllerAdministrationCustomerReport extends Controller {
  ...
  public function customer_view($id=0) {
	...
	$html .= '<p style="margin-bottom:2px;"><strong>'.$store_info['vstorename'].'</strong></p>';
	$html .= '<p style="margin-bottom:2px;"><strong>'.$store_info['vaddress1'].'</strong></p>';
	$html .= '<p style="margin-bottom:2px;"><strong>'.$store_info['vcity'].', '.$store_info['vstate'].' '.$store_info['vzip'].' </strong></p>';
	$html .= '<p style="margin-bottom:2px;"><strong>'.$store_info['vphone1'].'</strong></p>';
	$html .= '</div>';
	$html .= '</div>';
	$html .= '<br>';
