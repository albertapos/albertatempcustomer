                    ...
                    if(count($data['item_ids']) > 0){
                        ...
                        foreach($data['item_ids'] as $value){
                            ...
                            if(isset($data['update_dunitprice_checkbox']) && $data['update_dunitprice_checkbox'] == 'Y'){
                                $sql .= " dunitprice='0',";
                                $updated_column[] = 'dunitprice';
                            }else if(isset($data['update_dunitprice_select']) && $data['update_dunitprice_select'] == 'set as price' && $data['update_dunitprice'] != '0' && !isset($data['update_dunitprice_checkbox']) && !isset($data['update_dunitprice_increment'])){
                                $sql .= " dunitprice='" . $this->db->escape($data['update_dunitprice']) . "',";
                                $updated_column[] = 'dunitprice';
                            }elseif(isset($data['update_dunitprice_select']) && $data['update_dunitprice_select'] == 'set as price' && $data['update_dunitprice'] != '0' && !isset($data['update_dunitprice_checkbox']) && isset($data['update_dunitprice_increment']) && $data['update_dunitprice_increment'] == 'Y'){
                            ...
                            if(isset($data['update_dcostprice_checkbox']) && $data['update_dcostprice_checkbox'] == 'Y'){
                                ...
                                $current_dcostprice = 0;
                                $updated_column[] = 'dcostprice';
                            }else if(isset($data['update_dcostprice_select']) && $data['update_dcostprice_select'] == 'set as cost' && $data['update_dcostprice'] != '0' && !isset($data['update_dcostprice_checkbox']) && !isset($data['update_dcostprice_increment'])){
                                $sql .= " dcostprice='" . $this->db->escape($data['update_dcostprice']) . "',";
                                $current_dcostprice = $data['update_dcostprice'];
                                $updated_column[] = 'dcostprice';
                            }elseif(isset($data['update_dcostprice_select']) && $data['update_dcostprice_select'] == 'set as cost' && $data['update_dcostprice'] != '0' && !isset($data['update_dcostprice_checkbox']) && isset($data['update_dcostprice_increment']) && $data['update_dcostprice_increment'] == 'Y'){
