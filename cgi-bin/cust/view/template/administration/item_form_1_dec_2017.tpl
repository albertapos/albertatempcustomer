    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="row" style="padding-bottom: 9px;float: right;">
          <div class="col-md-12">
            <div class="">
              <button class="btn btn-info" onclick="$('#form-item').submit();">Save</button>
              <a id="cancel_button" href="<?php echo $cancel; ?>" data-toggle="tooltip" title="<?php echo $button_cancel; ?>" class="btn btn-default"><i class="fa fa-reply"></i>&nbsp;&nbsp;Cancel</a>
            </div>
          </div>
        </div>
        ...
        <div class="tab-content responsive">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <div class="form-group" style="border-top:none;">
                  ...
                  <div class="col-md-8">
                    <input type="text" name="dunitprice" value="<?php echo isset($dunitprice) ? $dunitprice : ''; ?>" placeholder="<?php echo $entry_sellingprice; ?>" id="input-Selling-Price" class="form-control"/>
                  </div>
                </div>
                <div class="form-group" style="border-top:none;">
              ...
              <div class="col-md-4">
                ...
                <div class="form-group" style="border-top:none;">
                  ...
                  <div class="col-md-8">
                    ...
                    <?php if(isset($arr_y_n) && count($arr_y_n) > 0){?>
                      <?php foreach($arr_y_n as $k => $array_y_n){ ?>
                        <?php if($ebottledeposit == $array_y_n) {?>
                          <option value="<?php echo $array_y_n;?>" selected="selected"><?php echo $array_y_n;?></option>
                        <?php }else{?>
                          <option value="<?php echo $array_y_n;?>"><?php echo $array_y_n;?></option>
                        <?php } ?>
          ...
          <div class="row">
            <div class="col-md-12 text-center">
              <input type="submit" form="form-item" title="<?php echo $button_save; ?>" class="btn btn-primary" value="Save">
              &nbsp;&nbsp;<a id="cancel_button" href="<?php echo $cancel; ?>" data-toggle="tooltip" title="<?php echo $button_cancel; ?>" class="btn btn-default"><i class="fa fa-reply"></i>&nbsp;&nbsp;Cancel</a>
            </div>
          </div>
          </div>
