    ...
    <div class="" style="margin-top:0%;">
      ...
      <td valign="top">
        <table width="100%" border="0" cellspacing="5" cellpadding="0" style="border-bottom:1px solid #999;">
          ...
          <tr style="line-height:25px;">
          <td width="50%" align="left"><strong>WINELAND</strong></td>
          <td width="25%" align="right"><strong>Status</strong></td>
          <td>&nbsp;&nbsp;Open</td>
          </tr>
          <tr style="line-height:25px;">
          <td width="50%" align="left"><strong>247 DeGraw Avenue</strong></td>
          <td width="25%" align="right"><strong>Ordered</strong></td>
          <td>&nbsp;&nbsp;04-02-2018</td>
          </tr>
          <tr style="line-height:25px;">
          <td width="50%" align="left"><strong>Teaneck NJ 07666</strong></td>
          <td width="25%" align="right"><strong>Invoiced</strong></td>
          <td>&nbsp;&nbsp;04-02-2018</td>
          </tr>
          <tr style="line-height:25px;">
          <td width="50%" align="left"><strong>201-530-WINE</strong></td>
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:5px 0px;">
        ...
        <td width="20%" align="right" style="padding-bottom:5px;">22.99</td>
        </tr>
        <tr style="border-top:1px solid #999;">
        <td width="70%" align="right" style="padding-bottom:5px;"><strong>Total</strong></td>
        <td width="10%" style="padding-bottom:5px;">&nbsp;</td>
        <td width="20%" align="right" style="padding-top:5px;padding-bottom:5px;">22.99</td>
        </tr>
      </table></td>
      </tr>
