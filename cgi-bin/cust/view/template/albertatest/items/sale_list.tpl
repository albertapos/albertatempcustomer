          ...
          <div class="table-responsive">
            ...
            <?php if ($sales) { ?>
              ...
              <tbody>
                ...
                <td class="text-left"><span><?php if($sale['dstartdatetime']!=''){echo date("m-d-y", strtotime($sale['dstartdatetime']));} ?></span></td>
                <td class="text-left"><span><?php if($sale['denddatetime']!=''){echo date("m-d-y", strtotime($sale['denddatetime']));} ?></span></td>
